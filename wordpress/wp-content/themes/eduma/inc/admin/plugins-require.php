...
function thim_get_all_plugins_require( $plugins ) {
	...
	$plugins = array(
		...
		array(
			...
			'premium'  => true,
			'required' => false,
			'icon'     => 'https://plugins.thimpress.com/downloads/images/lp-upsell.png?v=1',
			'add-on'   => true,
		),
		array(
			...
			'premium'  => true,
			'required' => false,
			'icon'     => 'https://plugins.thimpress.com/downloads/images/lp-assigment.png',
			'add-on'   => true,
		),
		array(
			...
			'premium'  => true,
			'required' => false,
			'icon'     => 'https://plugins.thimpress.com/downloads/images/lp-announcement.png',
			'add-on'   => true,
		),
 		array(
