		...
		<div class="thim-course-info">
			...
			<ul>
				...
				<li class="assessments-feature">
					<?php echo '<i class="tk tk-check-square"></i>'; ?>
	...
	function thim_display_course_filter() {
		if ( thim_is_new_learnpress( '4.2.3.2' ) ) {
			if ( get_theme_mod( 'thim_display_course_filter', false ) ) {
				...
				the_widget( 'LP_Widget_Course_Filter', $instance , array( 'before_widget' => '<div class="widget filter-course %s">', 'after_widget' => '</div>',));
			}
