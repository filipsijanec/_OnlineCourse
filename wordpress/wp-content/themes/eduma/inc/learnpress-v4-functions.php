...
// remove overwritten file of profile
add_filter('learn-press/profile/sidebar/sections', function (){
	return array(
 		'profile/sidebar/sidebar.php',
	);
});
// add hook  layout in page profile and remove file overwitten in theme
add_action( 'learn-press/user-profile-tabs', LearnPress::instance()->template( 'profile' )->callback( 'profile/sidebar/header.php' ), 5 );
...
add_filter('learn-press/user-profile-account',LearnPress::instance()->template( 'profile' )->callback( 'profile/header/user-bio.php' ), 25);
add_action( 'learn-press/user-profile-account', LearnPress::instance()->template( 'profile' )->text( ' <div class="lp-user-username-social">', 'lp-user-username-social-open' ), 11 );
add_filter('learn-press/user-profile-account',LearnPress::instance()->template( 'profile' )->callback( 'profile/header/user-name.php' ),11);
add_filter('learn-press/user-profile-account',LearnPress::instance()->template( 'profile' )->callback( 'profile/socials.php' ),11);
add_action( 'learn-press/user-profile-account', LearnPress::instance()->template( 'profile' )->text( ' </div>', 'lp-user-username-social-close' ), 11 );
