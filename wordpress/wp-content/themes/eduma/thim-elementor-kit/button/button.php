...
class Thim_Ekit_Widget_Button extends Widget_Base {
	...
	public function get_icon() {
		return 'eduma-eicon thim-widget-icon thim-widget-icon-button';
	}
	...
	protected function render() {
		...
		if ( isset( $settings['url'] ) && $settings['url'] ) {
			...
			$url_opt .= isset( $settings['new_window'] ) && $settings['new_window'] == 'yes' ? ' target="_blank"' : '';
			$url_opt .= isset( $settings['nofollow'] ) && $settings['nofollow'] == 'yes' ? ' rel="nofollow"' : '';
		}
		// old data
